...
export default function PrettyLogin() {
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl p-8 bg-white/5 backdrop-blur-md border border-white/6">
            ...
            <p className="text-sm text-slate-300 mb-6">Sign in to continue to your dashboard and manage your projects.</p>
            ...
            <div className="mt-8 text-sm text-slate-400">Need an account? <Link to="/register" className="text-white underline">Create one</Link></div>
          ...
          <div className="rounded-2xl bg-white/5 backdrop-blur-md p-8 shadow-2xl border border-white/6">
            ...
            <p className="text-sm text-slate-300 mb-6">Use your email and password to sign in — or continue with a provider.</p>
